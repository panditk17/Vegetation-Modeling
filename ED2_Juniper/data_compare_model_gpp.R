...
ED_estimate<-sims_gpp_modis[1:736,6]
plot(ED_estimate,MODIS_gpp,pch=16)


plotname1 <- paste0("daily_gpp_site1.png")
...
#par
lines(sims_gpp_modis[,3], type="l",ylab="", xlab="Year",col=coloth, xaxt="n",ylim= range(0,0.1))
#par
...
#par
lines(sims_gpp_modis[,5], type="l",ylab="", lwd=1.9,xlab="Year",col="green3", xaxt="n",ylim= range(0,0.1))
#par
...
mtext("ED2 vs MODIS GPP (Site 1) ", side = 3, line = -2, cex = 1.1)
